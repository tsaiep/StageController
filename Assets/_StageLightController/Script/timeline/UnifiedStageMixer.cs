    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            _clipInfos.Add(new ActiveClipInfo
            {
                ...
                groupRotationRangeCurve = b.groupRotationRangeCurve,
                lightDelayCurve        = b.lightDelayCurve,
                lightDelayFactor        = b.lightDelayFactor,
                lightRotationRangeCurve = b.lightRotationRangeCurve,
                ...
                useAudioAnalyzerBrightness = b.useAudioAnalyzerBrightness,
                audioBeatLightInterval = b.audioBeatLightInterval,
                audioBeatIndices = b.audioBeatIndices,
                audioBrightnessOffset = b.audioBrightnessOffset,
                audioBrightnessMultiplier = b.audioBrightnessMultiplier,
                audioBrightnessLerp = b.audioBrightnessLerp,
