    ...
    public class PlanarReflectionRenderer : MonoBehaviour {
        ...
        public Texture GetReflectionDepth( Camera cam ) {
            ...
            if ( cam.cameraType == CameraType.SceneView ) {
                ...
                if ( externalReflectionDepth ) {
                    return _sceneReflection != null && _sceneReflection._reflectionDepth != null ? (Texture)_sceneReflection._reflectionDepth : Texture2D.blackTexture;
                }
                ...
                if ( externalReflectionDepth ) {
                    return _reflectionData.ContainsKey( cam ) ? (Texture)externalReflectionDepth : Texture2D.blackTexture;
                }
        ...
        public void RenderURPReflection( ScriptableRenderContext context, Camera cam ) {
            ...
            && !isSceneCam
                    ...
                    refCamera.targetTexture = externalReflectionDepth?externalReflectionDepth:currentData._reflectionDepth;
...
#if UNITY_2023_3_OR_NEWER
                    rq.destination = externalReflectionDepth ? externalReflectionDepth : currentData._reflectionDepth;
                    refCamera.targetTexture = null;
                    UniversalRenderPipeline.SubmitRenderRequest( refCamera, rq );
                    refCamera.targetTexture = rq.destination;
#else
                ...
                else
                {
                    ...
                    refCamera.targetTexture = null;
                    refCamera.useOcclusionCulling = false;
                    refCamera.cullingMask = cam.cullingMask;
