...
namespace NiloToon.NiloToonURP
{
    ...
    public static class NiloToonPlanarReflectionHelper
    {
        ...
        public static bool IsPlanarReflectionCamera(Camera camera)
        {
            ...
            isPlanarReflectionCamera |= ContainsStringIgnoreCase(cameraName, "Reflect"); // PIDI 5, Mirrors and reflections for VR
            isPlanarReflectionCamera |= ContainsStringIgnoreCase(cameraName, "Mirror");
            isPlanarReflectionCamera |= ContainsStringIgnoreCase(cameraName, "RefCamera"); // PIDI 6
